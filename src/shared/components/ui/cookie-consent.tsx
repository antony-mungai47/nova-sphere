      ...
      {isVisible && (
        ...
        >
          <div className="glass-panel p-6 rounded-3xl border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.5)] bg-black/80 backdrop-blur-xl relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cta-primary via-amber-500 to-cta-primary"></div>
            ...
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-cta-primary/20 flex items-center justify-center flex-shrink-0 text-cta-primary mt-1">
            ...
            <div className="mt-4 pt-4 border-t border-white/5 flex justify-center gap-4 text-xs text-slate-300/70">
