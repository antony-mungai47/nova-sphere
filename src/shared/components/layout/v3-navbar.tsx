...
import { ShoppingCart, Menu, X, Gavel, LayoutDashboard, Store } from "lucide-react";
...
export function V3Navbar({ liveNotificationsEnabled = false, isAdmin = false, isVendor = false }: V3NavbarProps) {
          ...
          <div className="hidden md:flex items-center space-x-6 shrink-0">
            <nav className="flex items-center space-x-6 mr-4">
              ...
              <Show when="signed-in">
                ...
                {isAdmin && (
                  <Link href="/admin" className="text-sm font-medium text-success hover:text-foreground transition-colors flex items-center gap-1">
            ...
            >
              ...
              <div className="flex flex-col px-6 py-4 space-y-4 border-t border-border">
                ...
                <Show when="signed-in">
                  ...
                  {isVendor && (
                    <Link href="/seller" className="text-cta-secondary font-medium hover:text-foreground transition-colors flex items-center gap-2">
                      <LayoutDashboard className="w-4 h-4" /> Vendor Portal
                    </Link>
                  )}
                  {isAdmin && (
                    <Link href="/admin" className="text-success font-medium hover:text-foreground transition-colors flex items-center gap-2">
