  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white/5 border border-white/10 rounded-3xl overflow-hidden glass-panel">
        <div className="p-8 border-b border-white/10 bg-gradient-to-r from-cta-primary/10 to-transparent flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-white mb-1 flex items-center gap-2">
              <Lock className="w-5 h-5 text-green-400" /> Secure Checkout Simulation
            </h1>
            <p className="text-slate-300 text-sm">TEST MODE - No actual payment will be processed.</p>
          </div>
          ...
          <div className="bg-black/50 p-6 rounded-2xl border border-white/5">
            ...
            <div className="space-y-4 mb-8">
              <div className="p-4 bg-white/5 rounded-xl border border-white/10 flex items-center gap-3">
                <CreditCard className="text-cta-primary w-6 h-6" />
                <div>
                  <p className="text-white text-sm font-medium">Test Card ending in 4242</p>
                  <p className="text-slate-300 text-xs">Exp: 12/28 • CVC: ***</p>
                </div>
              </div>
            ...
            <form action="/api/checkout/simulate-webhook" method="POST">
              ...
              <div className="mb-4">
                <label className="text-slate-300 text-sm block mb-2">Simulate Scenario:</label>
                <select name="scenario" className="w-full bg-black/50 border border-white/10 text-white rounded-lg p-2 text-sm focus:outline-none focus:ring-1 focus:ring-cta-primary">
              ...
              <button 
                type="submit"
                className="w-full relative inline-flex items-center justify-center px-8 py-3 text-sm font-medium transition-colors rounded-full overflow-hidden focus:outline-none focus:ring-2 focus:ring-cta-primary focus:ring-offset-2 focus:ring-offset-background bg-cta-primary text-white hover:bg-orange- shadow-[0_0_20px_rgba(249,115,22,0.5)]"
              >
