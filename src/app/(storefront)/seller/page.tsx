      ...
      <div className="flex-1 pt-32 pb-24">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-16 relative">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-cta-primary/10 blur-[120px] rounded-full pointer-events-none" />
            <h1 className="text-5xl font-black text-white mb-6 tracking-tight relative z-10">
              Become a <span className="text-transparent bg-clip-text bg-gradient-to-r from-cta-primary to-emerald-500">Verified Seller</span>
            </h1>
            <p className="text-slate-300 text-xl max-w-2xl mx-auto relative z-10 font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="glass-panel p-8 rounded-3xl text-center flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-cta-primary/10 text-cta-primary flex items-center justify-center mb-6">
