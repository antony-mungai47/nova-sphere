...
const adminLinks = [
  { name: "Analytics", href: "/admin/analytics", icon: BarChart, color: "text-cta-primary", desc: "View store traffic and conversion metrics." },
  { name: "Financials", href: "/admin/financials", icon: DollarSign, color: "text-success", desc: "Manage revenue, payouts, and taxes." },
  { name: "Products", href: "/admin/products", icon: Package, color: "text-amber-500", desc: "Manage catalog, inventory, and categories." },
  ...
  { name: "Customers", href: "/admin/customers", icon: Users, color: "text-cta-primary", desc: "Manage user accounts and roles." },
  { name: "System Health", href: "/admin/health", icon: Activity, color: "text-success", desc: "Monitor server and database performance." },
  { name: "Audit Logs", href: "/admin/audit-logs", icon: FileText, color: "text-slate-300", desc: "Review system and security logs." },
  { name: "Settings", href: "/admin/settings", icon: Settings, color: "text-slate-300", desc: "Configure global store settings." },
];
  ...
  return (
    <main className="min-h-screen flex flex-col bg-black">
      ...
      <section className="pt-32 pb-16 relative overflow-hidden flex-1">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-cta-primary/5 rounded-full blur-[120px] -z-10 pointer-events-none" />
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-white/10 pb-6">
            <div>
              ...
              <p className="text-slate-300">Manage your store, view analytics, and configure settings.</p>
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h2 className="text-xl font-bold text-white group-hover:text-cta-primary transition-colors">{link.name}</h2>
                  </div>
                  <p className="text-slate-300 text-sm">{link.desc}</p>
                </Link>
              );
            })}
          </div>
