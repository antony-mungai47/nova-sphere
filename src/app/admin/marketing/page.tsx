  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-300">Create and manage discount codes to drive sales.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="glass-panel p-6 rounded-2xl border border-white/10 flex items-center gap-4">
          ...
          <div>
            <h3 className="text-slate-300 text-sm font-medium">Active Campaigns</h3>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-white/10 flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-cta-primary/10 flex items-center justify-center border border-cta-primary/20">
            <Tag className="w-6 h-6 text-cta-primary" />
          </div>
          <div>
            <h3 className="text-slate-300 text-sm font-medium">Total Coupons</h3>
