...
## 1. Purpose
Define the scope and critical functions of Auction.

## 2. Symptoms
Common user-facing or system-level symptoms of a Auction failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Auction issue.
