...
## 1. Purpose
Define the scope and critical functions of Clerk.

## 2. Symptoms
Common user-facing or system-level symptoms of a Clerk failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Clerk issue.
