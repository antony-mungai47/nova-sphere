...
## 1. Purpose
Define the scope and critical functions of Inngest.

## 2. Symptoms
Common user-facing or system-level symptoms of a Inngest failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Inngest issue.
