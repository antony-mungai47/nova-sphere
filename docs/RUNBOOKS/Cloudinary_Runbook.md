...
## 1. Purpose
Define the scope and critical functions of Cloudinary.

## 2. Symptoms
Common user-facing or system-level symptoms of a Cloudinary failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Cloudinary issue.
