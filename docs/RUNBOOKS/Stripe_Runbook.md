...
## 1. Purpose
Define the scope and critical functions of Stripe.

## 2. Symptoms
Common user-facing or system-level symptoms of a Stripe failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Stripe issue.
