...
## 1. Purpose
Define the scope and critical functions of Pusher.

## 2. Symptoms
Common user-facing or system-level symptoms of a Pusher failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Pusher issue.
