...
## 1. Purpose
Define the scope and critical functions of Neon.

## 2. Symptoms
Common user-facing or system-level symptoms of a Neon failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Neon issue.
