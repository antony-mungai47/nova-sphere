...
## 1. Purpose
Define the scope and critical functions of Checkout.

## 2. Symptoms
Common user-facing or system-level symptoms of a Checkout failure.
...
## 5. Diagnosis
Steps to identify the root cause of the Checkout issue.
